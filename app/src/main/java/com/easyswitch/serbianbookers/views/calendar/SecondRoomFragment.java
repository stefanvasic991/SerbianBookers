...
public class SecondRoomFragment extends Fragment {
    ...
    public static SecondRoomFragment newInstance() {

        Bundle args = new Bundle();

        SecondRoomFragment fragment = new SecondRoomFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_dvosobni, container, false);
        ...
        av.setDto(LocalDate.now().plusDays(40).toString());
        ...
        webApiClient.getAvailability(av).observe(this, new Observer<Availability>() {
            ...
            public void onChanged(Availability availability) {
                ...
                if (availability.getAvailabilityList() != null) {
                    calendarList.clear();
                    calendarList.addAll(availability.getAvailabilityList().get(1).getData());
                    calendarAdapter.notifyDataSetChanged();
                } else {
                    List<AvailabilityData> tmpList = new ArrayList<>();
                    tmpList.addAll(availability.getAvailabilityList().get(1).getData());
                }
                    id = availability.getAvailabilityList().get(1).getId();
    ...
    public void onResume() {
        ...
        broadcastReceiver = new BroadcastReceiver() {
            ...
            public void onReceive(Context context, Intent intent) {
                ...
                a.setDto(LocalDate.now().plusDays(40).toString());
                a.setArr("");
//                a.setPriceId("121900");
                ...
                WebApiManager.get(getContext()).getWebApi().availability(a).enqueue(new Callback<Availability>() {
                    ...
                    public void onResponse(Call<Availability> call, Response<Availability> response) {
                        if (response.isSuccessful()) {
                            calendarList.clear();
                            calendarList.addAll(response.body().getAvailabilityList().get(1).getData());
                            calendarAdapter.notifyDataSetChanged();
                        } else {}
                    }
