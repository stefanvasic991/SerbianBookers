...
public class GuestNotShowDialog extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_guest_not_show);
    ...
    public void noShow() {
        ...
        webApiClient.getGuestNotShow(notShow).observe(this, new Observer<GuestNotShow>() {
            @Override
    ...
    public static void show(Activity activity, String question){
        Intent i = new Intent(activity, GuestNotShowDialog.class);
    ...
    public static void show(Fragment fragment, String question){
        Intent i = new Intent(fragment.getActivity(), GuestNotShowDialog.class);
        i.putExtra("question", question);
