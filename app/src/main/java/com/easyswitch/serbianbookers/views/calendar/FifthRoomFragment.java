...
public class FifthRoomFragment extends Fragment {
    ...
    ImageView ivClose;
    LinearLayout llInfo;
    Integer id, closedOptions, arrID;
        ...
        webApiClient.getCalDetails(c).observe(this, new Observer<Calendar>() {
            ...
            public void onChanged(Calendar calendar) {
                ...
                if (calendar.getAvailabilityList() != null) {
                    calendarList.clear();
                    calendarList.addAll(calendar.getAvailabilityList().get(4).getData());
                    calendarAdapter.notifyDataSetChanged();
                } else {
                    List<AvailabilityData> tmpList = new ArrayList<>();
                    tmpList.addAll(calendar.getAvailabilityList().get(4).getData());
                }
            }
        });
    ...
    public void onResume() {
        ...
        broadcastReceiver = new BroadcastReceiver() {
            ...
            public void onReceive(Context context, Intent intent) {
                ...
                Toast.makeText(context, arrID+" "+priceID+" "+restrictionID, Toast.LENGTH_SHORT).show();
