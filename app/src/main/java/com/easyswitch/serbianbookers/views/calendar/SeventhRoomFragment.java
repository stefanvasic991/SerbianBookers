 ...
 */
public class SeventhRoomFragment extends Fragment {
    ...
    public static SeventhRoomFragment newInstance() {
        Bundle args = new Bundle();
        SeventhRoomFragment fragment = new SeventhRoomFragment();
        fragment.setArguments(args);
        return fragment;
    }

    public SeventhRoomFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        webApiClient.getCalDetails(c).observe(this, new Observer<Calendar>() {
            ...
            public void onChanged(Calendar calendar) {
                ...
                roomID = calendar.getAvailabilityList().get(6).getId();
